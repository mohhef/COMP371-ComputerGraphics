...
static  vector<vector<glm::vec3>> wallCubePositions =
{
	...
	{
		glm::vec3(0.0f, 0.0f, wallZPos),
		glm::vec3(0.0f, 20.0f, wallZPos),
		glm::vec3(-7.5f, 10.0f, wallZPos),
		glm::vec3(7.5f, 10.0f, wallZPos),
		glm::vec3(-2.0f, 10.0f, wallZPos),
		glm::vec3(-1.0f, 8.0f, wallZPos),
		glm::vec3(3.0f, 10.0f, wallZPos),
	},
};
...
static vector<vector<glm::vec3>> modelCubePositions =
{
	...
	},
	{
		...
		{
		glm::vec3(0.0f, 0.0f, 0.0f), // cubes in 3d snake mode
		glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(0.0f, 2.0f, 0.0f),  glm::vec3(0.0f, 2.0f, 1.0f), 
		glm::vec3(0.0f, 2.0f, 2.0f), glm::vec3(1.0f, 2.0f, 2.0f), glm::vec3(2.0f, 2.0f, 2.0f),
		glm::vec3(2.0f, 2.0f, 1.0f),  glm::vec3(2.0f, 2.0f, 0.0f), 	glm::vec3(2.0f, 2.0f, -1.0f),  glm::vec3(2.0f, 2.0f, -2.0f),
		glm::vec3(1.0f, 2.0f, -2.0f), glm::vec3(0.0f, 2.0f, -2.0f), glm::vec3(-1.0f, 2.0f, -2.0f), glm::vec3(-2.0f, 2.0f, -2.0f),
		glm::vec3(-2.0f, 2.0f, -1.0f), glm::vec3(-2.0f, 2.0f, 0.0f), glm::vec3(-2.0f, 2.0f, 1.0f), glm::vec3(-2.0f, 2.0f, 2.0f),
		glm::vec3(-2.0f, 1.0f, 2.0f), glm::vec3(-2.0f, 0.0f, 2.0f), glm::vec3(-2.0f, -1.0f, 2.0f), glm::vec3(-2.0f, -2.0f, 2.0f),
		glm::vec3(-1.0f, -2.0f, 2.0f), glm::vec3(0.0f, -2.0f, 2.0f), glm::vec3(1.0f, -2.0f, 2.0f), glm::vec3(2.0f, -2.0f, 2.0f),
		glm::vec3(2.0f, -2.0f, 1.0f), glm::vec3(2.0f, -2.0f, 0.0f), glm::vec3(2.0f, -2.0f, -1.0f), glm::vec3(2.0f, -2.0f, -2.0f),
		glm::vec3(1.0f, -2.0f, -2.0f), glm::vec3(0.0f, -2.0f, -2.0f), glm::vec3(-1.0f, -2.0f, -2.0f), glm::vec3(-2.0f, -2.0f, -2.0f),
		glm::vec3(-2.0f, -2.0f, -1.0f), glm::vec3(-2.0f, -2.0f, 0.0f), glm::vec3(-1.0f, -2.0f, 0.0f), glm::vec3(-0.0f, -2.0f, 0.0f),
